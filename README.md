...
<p align="center">
  <a href="https://uk.linkedin.com/in/sulvin-varghese?trk=profile-badge">
    <img src="https://img.shields.io/badge/LinkedIn-Sulvin%20Varghese-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Badge"/>
  </a>
</p>
...
I've spent the last 5 years working on blockchain projects across enterprise and startup environments.

At UST Global, I worked on a vehicle lifecycle tracking system for Hero MotoCorp built on Hyperledger Fabric and AWS Managed Blockchain — connecting manufacturers, dealerships, service centres, and insurers through a shared, tamper-proof record. My role was mostly designing the backend APIs that bridged the off-chain services to the blockchain layer.

Before that, at Kottackal Business Solutions, I worked across several payment and fintech platforms — writing Solidity contracts, integrating Ethereum into Node.js backends, and handling ERC-20 token flows, multisig approvals, and IPFS storage across systems with real users.

My background is backend-heavy, but I've always worked close to the smart contract layer — writing contracts, integrating Web3.js, and keeping the two sides in sync.

I also completed an MSc in Cyber Security from Coventry University with Distinction, covering ethical hacking, threat modelling, and secure system design.
